    ...
    <div class="col-md-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  Bienvenido! por favor seleciona una opcion en el lado lateral izquierdo
                </div>
            </div>
        </div>
            ...
            @endif
              <form action="{{url('/fcm/send')}}"method="post" >
                  ...
                  <div class="form-group">
                    ...
                    <input id="tittle" value="{{config('app.name')}}" class="form-control" type="text" name="tittle" required>
                  </div>
                  <div class="form-group">
            ...
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h2 class="mb-0">Segun día de la semana</h2>
                </div>
              </div>
            </div>
            <div class="card-body">
